...
Copied from Modal Labs QuiLLMan example: https://github.com/modal-labs/quillman
"""
import time
from pathlib import Path

from modal import Image, method, Stub

stub = Stub(name="advisor")
...
stub.vicuna_image = (
    Image.from_dockerhub(
        "nvidia/cuda:11.7.1-devel-ubuntu22.04", # Version tied to that used to build pytorch in deps.
...
def debug_generate():
    ...
    for val in model.generate.call("Where is the best sushi in New York?"):
